...
@Component({
  ...
  template: `
    <section class="home">
<img src="/portfolio-website/assets/laptop_img.png" alt="Home Image" class="home-image">
    <img src="/portfolio-website/assets/laptop_img.png" id = "background-image" alt="Home Image" class="home-image">
      <div class = "summary">
